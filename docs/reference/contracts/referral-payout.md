...
`0xB03Cbd862F47059e928C113182814c676eA29d4c` · [view on evm.now](https://evm.now/address/0xB03Cbd862F47059e928C113182814c676eA29d4c?chainId=1) · deployed at block 25270161
...
const referralPayout = "0xB03Cbd862F47059e928C113182814c676eA29d4c" as const;
...
```solidity
function CLAIM_GAS() external view returns (uint256)
```
