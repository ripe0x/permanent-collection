...
`0x8C72FBc2bB32e76aa54243F76745266a0F92CD01`. The adapter is the single faucet into the bid:
...
const ADAPTER = '0x8C72FBc2bB32e76aa54243F76745266a0F92CD01';
...
```solidity
ILiveBidAdapter(0x8C72FBc2bB32e76aa54243F76745266a0F92CD01).contribute{value: amount}(
    referrer,
